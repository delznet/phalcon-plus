...
class Str
{
     ...
     * @return string
     */
    public static function hyphenate(string $value):string
    {
     ...
     */
    public static function subString(string $value, int $start = 0, int $length, string $suffix = null):string
    {
     ...
     * @return bool
     */
    public static function isChinese(string $value):bool
    {
        $value = (string)$value;
